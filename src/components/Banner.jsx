...
import profile from '../assets/Ruhan.png'
import { ReactTyped } from "react-typed";


const GITHUB = 'https://github.com/ruhanahmed01706'
const CV_LINK = 'https://docs.google.com/document/d/1oLfozW5t4CguKDPozbSVHpsbldLxoD55drhFdVHqFpI/edit?tab=t.0#heading=h.htpvu4ejxoek'


export default function Banner() {
    return (
        <section  id="home" className="min-h-screen  flex items-center pt-20">
            <div className="container bg-orange-100 shadow-2xl px-15 py-10 rounded-2xl mx-auto px-4">
                <div className="grid md:grid-cols-2 items-center gap-8">
                    <div>
                        <h1 className="text-4xl md:text-6xl h-28 font-bold mb-3">
                            I'm a{" "}
                            <ReactTyped
                                strings={["Ruhan Ahmmed", "Front-End Developer"]}
                                typeSpeed={90}
                                backSpeed={70}
                                loop
                            />
